  ...
  <div class="col-md-12 bootstrap snippets">
      <div class="panel-body">
        ...
        <div class="mar-top  clearfix">
          <button class="btn btn-sm btn-primary pull-right mar-bottom" type="submit"><i class="fa fa-pencil fa-fw"></i> Comments</button>
    ...
    <div>
        ...
        <div class="media-block">
          ...
          <div class="media-block">
            ...
            <div class="media-body">
              <div class="mar-btm">
                <small class=""> <a href="#">Jane Seymour</a> <span class="text-muted d-block">A few hours ago &middot; 5 min. read</span>
    						</small>
              </div>
          ...
          <div class="media-block">
            ...
            <div class="media-body">
              <div class="mar-btm">
                <a href="#" class="btn-link ">Bobby Marz</a>
          ...
          <div class="media-block">
            ...
            <div class="media-body">
              <div class="mar-btm">
                <a href="#" class="btn-link text-semibold   ">Lucy Moon</a>
        ...
        <div class="media-block pad-all">
          ...
          <div class="media-body">
            <div class="mar-btm">
              <a href="#" class="btn-link text-semibold   ">John Doe</a>
            ...
            <div>
              <div class="media-block pad-all">
                ...
                <div class="media-body">
                  <div class="mar-btm">
                    <a href="#" class="btn-link text-semibold   ">Maria Leanz</a>
                    <p class="text-muted text-sm"><i class="fa fa-globe fa-lg"></i> - From Web - 2 min ago</p>
                  </div>
                  <p>Duis autem vel eum iriure dolor in hendrerit in vulputate ?</p>
                  <div>
