		...
		<div class="col-lg-6">
			<div class="card border-0 mb-4 box-shadow h-xl-300">
				...
				<div class="card-body px-0 pb-0 d-flex flex-column align-items-start">
					...
					<a class="text-dark" href="{{ route('story') }}">Brain Stimulation Relieves Depression Symptoms</a>
					</h2>
					<p class="card-text">
	...
	<div class="row justify-content-between">
		<div class="col-md-8">
			...
			<div class="mb-3 d-flex justify-content-between">
				<div class="pr-3">
					...
					<a class="text-dark" href="{{ route('story') }}">Nearly 200 Great Barrier Reef coral species also live in the deep sea</a>
					</h2>
					<p>
			...
			<div class="mb-3 d-flex justify-content-between">
				<div class="pr-3">
					<h2 class="mb-1 h4 font-weight-bold">
					<a class="text-dark" href="{{ route('story') }}">East Antarctica's glaciers are stirring</a>
					</h2>
					<p>
			...
			<div class="mb-3 d-flex justify-content-between">
				<div class="pr-3">
					<h2 class="mb-1 h4 font-weight-bold">
					<a class="text-dark" href="{{ route('story') }}">50 years ago, armadillos hinted that DNA wasn’t destiny</a>
					</h2>
					<p>
						Nasa says it has detected the first signs of significant melting in a swathe of glaciers in East Antarctica.
					</p>
		...
		<div class="col-md-4 pl-4">
			...
			<ol class="list-featured">
				...
				<a href="{{ route('story') }}" class="text-dark">Did Supernovae Kill Off Large Ocean Animals?</a>
				</h6>
				<p class="text-muted">
					Jake Bittle in SCIENCE
				</p>
				...
				<span>
				<h6 class="font-weight-bold">
				<a href="{{ route('story') }}" class="text-dark">Humans Reversing Climate Clock: 50 Million Years</a>
				</h6>
				<p class="text-muted">
					Jake Bittle in SCIENCE
				</p>
				...
				<span>
				<h6 class="font-weight-bold">
				<a href="{{ route('story') }}" class="text-dark">Unprecedented Views of the Birth of Planets</a>
				</h6>
				<p class="text-muted">
					Jake Bittle in SCIENCE
				</p>
				...
				<span>
				<h6 class="font-weight-bold">
				<a href="{{ route('story') }}" class="text-dark">Effective New Target for Mood-Boosting Brain Stimulation Found</a>
				</h6>
				<p class="text-muted">
					Jake Bittle in SCIENCE
				</p>
